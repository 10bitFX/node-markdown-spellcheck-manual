...
exports.default = function (src) {
  ...
  tracker.replaceAll(/[0-9\.]+(mm)+/i, " "); // measurements in mm
  tracker.replaceAll(/[a-zA-Z0-9_-]+\.((dfx)|(exe)|(jpg)|(jpeg)|(dll)|(nvf)|(obj)|(fbx)|(WibuCmRaU)|(WibuCmRaC)|(sbasar)|(ini))/i, " "); // remove file extensions
  // END CUSTOM
